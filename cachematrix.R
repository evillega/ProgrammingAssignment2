...
makeCacheMatrix <- function(x = matrix()) {
	...
	## Returns a list of the matrix with the given defined functions above
	list (set = set, 
		  get = get, 
...
## The following function "cacheSolve" calcultes the inverse of the "makeCacheMatrix" matrix above.
